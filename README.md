...
In this example, you can find code to define map center, zoom level, to create a maker, polyline, polygon, circle, trace user's current location and trace the magnetic heading with Route-Me framework
